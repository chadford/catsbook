...
object TreeSuite extends FunSuite {
  ...
  test("Exercise 3.5.4: Tree Functor: map transforms a Branch from Branch[Int] to Branch[String]") {
  ...
  test("Exercise 3.5.4: Tree Functor: map transforms a Leaf from Leaf[Int] to Leaf[String]") {
